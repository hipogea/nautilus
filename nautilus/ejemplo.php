...
public function nuevafucion(){
	...
	public function accessRules()
	{
		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('admin','config','parametros','esarchivo','rutas','pio','matrices','moneda'),
				'users'=>array('@'),
			),
	...
	public function actionesarchivo(){
        ...
        //echo Alinventario::getcamposstock();
		$alin=New Alinventario();
		$matrizinv=$alin->getStockAlmacenes();
        print_r($matrizinv);
        echo "<br>";
        foreach($matrizinv as $clave=>$valor){
            print_r($valor);
            echo "<br><br>";
        }
        ...
        echo $matrizinv[0]['codcen']."<br>";
		echo $matrizinv[0]['nomal']."<br>";
		echo $matrizinv[0]['stock_canttran']."<br>";
		echo $matrizinv[0]['stock_cantlibre']."<br>";
