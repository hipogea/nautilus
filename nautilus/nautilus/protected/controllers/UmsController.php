...
class UmsController extends Controller
{
	...
	{  Yii::app()->user->loginUrl = array("/cruge/ui/login");
		return
			ARRAY(array('allow',
				'actions'=>array('create','cargaum','index','delete','update'),
				'users'=>array('@'),
		));
	}
	...
	{
		$dataProvider=new CActiveDataProvider('Ums');
	...
	{
		$model=new Ums('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ums']))
			$model->attributes=$_GET['Ums'];
	 ...
	 * @param Ums $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ums-form')
		{
